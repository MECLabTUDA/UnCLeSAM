"""
This file is from the PCG Network which generates point clouds for RGB images. We modified it so it 
learns to generate points that can be sampled to use SAM for medical image segmentation:
https://github.com/lkhphuc/pytorch-3d-point-cloud-generation/blob/d26a65cf701a35b87b4a0329986057eb542d36c1/PCGModel.py#L109
"""
