...
import sys, os
from scripts import train_adapter as train
...
for tasks in train_on:
    ...
    for task in tasks:
        ...
        out_folder = f'/media/aranem_locale/AR_subs_exps/MIDL_2024/MIDL_2024_trained_models_prost_huge/Seq/sam_adapter_{built_ts}_{nr_samples}_lr-1e-4-with-adapter-lr-1e-3'
        ...
        # exp_name = built_ts + "_lr-1e-4-with-adapter-lr-1e-3_huge"
        exp_name = built_ts + "_lr-1e-4-with-adapter-lr-1e-3"
